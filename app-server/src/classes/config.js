  ...
  init() {
    Object.assign(this, {
      ...
      paperSizes: [
        ...
        { name: 'B3 (@:paper-size.portrait)', dimensions: { x: 364, y: 515 } },
        { name: 'B4 (@:paper-size.portrait)', dimensions: { x: 257, y: 364 } },
        { name: 'B5 (@:paper-size.portrait)', dimensions: { x: 182, y: 257 } },
        { name: 'B5 (@:paper-size.landscape)', dimensions: { x: 257, y: 182 } },
        { name: 'B6 (@:paper-size.portrait)', dimensions: { x: 128, y: 182 } },
        { name: 'B6 (@:paper-size.landscape)', dimensions: { x: 182, y: 128 } },
